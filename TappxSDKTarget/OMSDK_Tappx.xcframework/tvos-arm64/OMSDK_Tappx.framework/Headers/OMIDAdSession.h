 ...
 */
@interface OMIDTappxAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDTappxAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDTappxAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDTappxAdSessionContext *)context
